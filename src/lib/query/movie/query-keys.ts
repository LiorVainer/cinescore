...
export const movieKeys = {
    ...
    list: (page?: number, limit?: number) =>
        [...movieKeys.all, 'list', {page, limit}] as const,
    ...
    byGenre: (genre: string, page?: number) =>
        [...movieKeys.all, 'genre', genre, {page}] as const,

    // Movies by actor
    byActor: (actorName: string, page?: number) =>
        [...movieKeys.all, 'actor', actorName, {page}] as const,
