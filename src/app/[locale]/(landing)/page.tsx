...
export default async function LandingPage({params}: Props) {
    ...
    return (
        <main className="relative flex flex-col overflow-x-visible overflow-y-auto h-full w-screen items-center justify-between gap-20">
            ...
            <section className="relative w-[260vw] md:w-[140vw] bg-gradient-to-t from-primary to-primary/70 px-6 md:px-12 pt-12 md:pt-16 rounded-t-[400px] sm:rounded-t-full flex flex-col justify-center items-center">
