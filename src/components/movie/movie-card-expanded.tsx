                ...
                >
                    ...
                    {variant === 'modal' && (
                        <>
                            <motion.div
                                layoutId={
                                    layoutIdEnabled ? MOVIERCARD_LAYOUT_ID_GENERATORS.IMAGE(title, idSuffix) : undefined
                                }
                            ...
                            <div className='p-6 flex flex-col gap-2 lg:gap-4 flex-1 min-w-0 overflow-y-auto w-full relative z-10'>
                                                ...
                                                <div className='flex-1 min-w-0'>
                                                    ...
                                                    {isLocaleLanguageDiffrentFromOriginal && originalLangLabel && (
                                                        <motion.p
                                                            layoutId={
                                                                layoutIdEnabled
                                                                    ? MOVIERCARD_LAYOUT_ID_GENERATORS.ORIGINAL(
                                                                          title,
                                                                          idSuffix,
                                                                      )
                                                                    : undefined
                                ...
                                <div className='flex flex-col gap-4'>
                                    <motion.p
                                        ...
                                        layoutId={
                                            layoutIdEnabled
                                                ? MOVIERCARD_LAYOUT_ID_GENERATORS.DESCRIPTION(idSuffix)
                                                : undefined
                                        }
                                    >
                                        {movie.description}
